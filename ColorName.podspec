#
#  Be sure to run `pod spec lint UptickSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/ztpr0035/ios-random-colors"
  ...
  spec.source       = { :git => "https://github.com/ztpr0035/ios-random-colors.git", :tag => "#{spec.version}" }
